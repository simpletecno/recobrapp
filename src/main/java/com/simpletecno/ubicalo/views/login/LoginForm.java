package com.simpletecno.ubicalo.views.login;
...
public class LoginForm extends VerticalLayout {
    ...
    public final TextField farmName = new TextField("UBICALO");
...
//        fields.addComponents(farmName, userName, password, signIn);
        ...
        signIn.setId("LOGIN");
        signIn.addClickListener(((UbicaloUI) UI.getCurrent()));
    ...
    private Component buildLabels() {
        ...
        Label title = new Label("Sistema UBICALO v 1.0");
