package com.simpletecno.recobrapp.views.login;
...
public class LoginForm extends VerticalLayout {
    ...
    public final TextField farmName = new TextField("RECOBRAPP");
...
**/
    ...
    private Component buildLoginForm() {
        ...
        Label instructionsLbl = new Label("Desarrollado por SIMPLETECNO");
...
//        fields.addComponents(farmName, userName, password, signIn);
        ...
        signIn.setId("LOGIN");
        signIn.addClickListener(((RecobrAppUI) UI.getCurrent()));
    ...
    private Component buildLabels() {
        ...
        Label title = new Label("Sistema RECOBRAPP v 1.0");
