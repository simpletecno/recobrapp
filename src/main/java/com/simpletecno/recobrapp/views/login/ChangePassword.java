...
{      
    ...
    public PasswordField txtPasswordNueva;
    public PasswordField txtPasswordNueva1;
...
// Validator for validating the passwords
    ...
    public void buttonClick(ClickEvent event) {
        ...
        if(source == acceptBtn) {
            ...
            if(((RecobrAppUI)UI.getCurrent()).databaseProvider.getUsedDBDataSource().equals("MYSQL")) {
...
System.out.println("query cambio de clave="+queryString);
                    ...
                    if(lastLogin != null) {
                        ((RecobrAppUI) UI.getCurrent()).logOff();
                    }
                    else {
                        close();
                    }
