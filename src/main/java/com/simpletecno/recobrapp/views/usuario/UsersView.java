...
//        usersTable.addContainerProperty(EMAIL_PROPERTY,     String.class, null);
    ...
    public void fillReportTable() {
        ...
        if(((RecobrAppUI) mainUI).sessionInformation.getStrUserProfile().compareTo("DESARROLLADOR") == 0) {
            queryString += " And Usr.IdEmpresa = " + ((RecobrAppUI)mainUI).sessionInformation.getStrCompanyId();
        }
        if(nombreTxt != null) {
...
//System.out.println("\n\n"+queryString);
    ...
    public boolean exportToExcel() {
        ...
        String mainTitle = "RECOBRAPP - USUARIOS AL: "  + new Utileria().getFechaYYYYMMDD_1(new Date());
    ...
    public void enter(ViewChangeListener.ViewChangeEvent event) {
        Page.getCurrent().setTitle("RECOBRAPP - USUARIOS ");
