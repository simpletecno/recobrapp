 ...
 */
package com.simpletecno.recobrapp.views.usuario;
...
public class UserForm extends Window {
    ...
    public UserForm() {
        ...
        Page.getCurrent().setTitle("RecobrApp - Usuario");
    ...
    public void fillCompanyCombo() {
        ...
        queryString += " From  empresa ";
         ...
         if(((RecobrAppUI) mainUI).sessionInformation.getStrUserProfile().compareTo("DESARROLLADOR") == 0) {
            queryString += " Where IdEmpresa = " + ((RecobrAppUI)mainUI).sessionInformation.getStrCompanyId();
        }
//System.out.println("\n\n"+queryString);
    ...
    private void saveUsuario() {
        ...
        try {
            if(idUsuario == 0) {
                ...
                queryString += " And IdEmpresa = "  + ((RecobrAppUI) mainUI).sessionInformation.getStrCompanyId();
...
//System.out.println("\n\n"+queryString);
                ...
                if(((RecobrAppUI) mainUI).databaseProvider.getUsedDBDataSource().equals("MYSQL")) {            
...
System.out.println("queryString="+queryString);
            ...
            if(idUsuario > 0) {
                ...
                stPreparedQuery  = ((RecobrAppUI) mainUI).databaseProvider.getCurrentConnection().prepareStatement(queryString, Statement.RETURN_GENERATED_KEYS);
