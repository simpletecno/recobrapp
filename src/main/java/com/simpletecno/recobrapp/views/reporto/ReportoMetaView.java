...
public class ReportoMetaView extends VerticalLayout implements View {
    ...
    public ReportoMetaView() {
        ...
        Label titleLbl = new Label(((RecobrAppUI)this.mainUI).sessionInformation.getStrUserFullName());
    ...
    public void llenarGridAvanceMeta() {
        ...
        queryString = queryString + " and usr.IdUsuario = " + ((RecobrAppUI)mainUI).sessionInformation.getStrUserId();
    ...
    public void insertReporto() {
        ...
        queryString = queryString + ((RecobrAppUI)mainUI).sessionInformation.getStrUserId();
    ...
    public void enter(ViewChangeListener.ViewChangeEvent event) {
        Page.getCurrent().setTitle("RECOBRAPP - Reportar Recuperación");
    }
}
