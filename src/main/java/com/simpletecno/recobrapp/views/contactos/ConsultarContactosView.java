package com.simpletecno.recobrapp.views.contactos;

import com.simpletecno.recobrapp.main.RecobrAppUI;
import com.simpletecno.recobrapp.utileria.Utileria;
import com.simpletecno.recobrapp.views.finiquitos.CargarArchivoIngresoDocumentos;
 ...
 * @author user
 */
public class ConsultarContactosView extends VerticalLayout implements View {
...
//        titleLayout.setComponentAlignment(excelBtn, Alignment.MIDDLE_RIGHT);
    ...
    public void llenarGrid(String nombre) {
        ...
        try {
            ...
            System.out.println("Error al listar tabla de CONTACTOS : " + ex);
            ex.printStackTrace();
        }
    }
    ...
    public boolean exportToExcel() {
        if (this.contactosGrid.getHeightByRows() > 0) {
            ...
            String fileexport;
            fileexport = ("RECOBRAPP_contactos.xls").replaceAll(" ", "").replaceAll(",", "");
    ...
    public void enter(ViewChangeListener.ViewChangeEvent event) {
        Page.getCurrent().setTitle("RECOBRAPP - Consulta de contactos");
    }
}
