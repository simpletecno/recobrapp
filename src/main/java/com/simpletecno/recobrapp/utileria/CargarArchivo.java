...
public class CargarArchivo extends Window {
    ...
    String queryString, codigoPartidaUpdate;
    String parametro1, parametro2;

    long parametro3;
    long fileSize = 12;

    public CargarArchivo(Object selectedObject, String correlativo) {
        this.mainUI = UI.getCurrent();
        this.selectedObjectUpdate = selectedObject;
        this.codigoPartidaUpdate = correlativo;
        setResponsive(true);
        setWidth("50%");
        setHeight("30%");
...
//                        fileName = filePath + codigoPartidaUpdate + fileName.substring(fileName.length()-4, fileName.length());
                        ...
                        System.out.println("mineType trae" + mimeType);
    ...
    public void guardarArchivo(Object selectedObject, String correlativo, String fileName) {
        ...
        try {
            ...
            if (mainUI.getNavigator().getCurrentView().getClass().getSimpleName().equals("ConsultarFiniquitosView")) {
                ...
                //((ConsultarFiniquitosView) (mainUI.getNavigator().getCurrentView())).finiquitosContainer.getContainerProperty(selectedObject, ConsultarFiniquitosView.DOCUMENTO_PROPERTY).setValue("Visualizar");
                ...
                //((ConsultarFiniquitosView) (mainUI.getNavigator().getCurrentView())).finiquitosContainer.getContainerProperty(selectedObject, ConsultarFiniquitosView.ARCHIVO_TIPO_PROPERTY).setValue(parametro2);
            }
